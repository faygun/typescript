...
var ShipmentListener = /** @class */ (function () {
    function ShipmentListener() {
    }
    ShipmentListener.prototype.receiveUpdate = function (id, shipmentData) {
        return __awaiter(this, void 0, void 0, function () {
            var release;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        release = _a.sent();
                        return [4 /*yield*/, new ShipmentSearchIndex().updateShipment(id, shipmentData)];
                    case 2:
                        _a.sent();
                        release();
                        return [2 /*return*/];
...
exports.ShipmentListener = ShipmentListener;
var shipment = new ShipmentListener();
